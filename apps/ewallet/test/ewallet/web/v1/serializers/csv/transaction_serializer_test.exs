  ...
  describe "serialize/1 for a single transaction" do
    test "serializes into correct V1 transaction format" do
      ...
      expected = %{
        ...
        metadata: Jason.encode!(transaction.metadata || %{}),
        encrypted_metadata: Jason.encode!(transaction.encrypted_metadata || %{}),
      ...
      expected = %{
        ...
        data: [
          %{
            ...
            from_token_subunit_to_unit: Assoc.get(transaction_1, [:from_token, :subunit_to_unit]),
            ...
            to_token_subunit_to_unit: Assoc.get(transaction_1, [:to_token, :subunit_to_unit]),
            ...
            metadata: Jason.encode!(transaction_1.metadata || %{}),
            encrypted_metadata: Jason.encode!(transaction_1.encrypted_metadata || %{}),
          ...
          %{
            ...
            from_token_subunit_to_unit: Assoc.get(transaction_2, [:from_token, :subunit_to_unit]),
            ...
            to_token_subunit_to_unit: Assoc.get(transaction_2, [:to_token, :subunit_to_unit]),
            ...
            metadata: Jason.encode!(transaction_2.metadata || %{}),
            encrypted_metadata: Jason.encode!(transaction_2.encrypted_metadata || %{}),
